...
```shell
export COPILOT_PROVIDER_BASE_URL=http://localhost:11433/v1
...
```shell
COPILOT_PROVIDER_BASE_URL=http://localhost:11433/v1 COPILOT_PROVIDER_API_KEY= COPILOT_PROVIDER_WIRE_API=responses COPILOT_MODEL=glm-5:cloud copilot
```
