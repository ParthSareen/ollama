...
3. **Onboarding** — Ollama configures the Ollama provider, points Hermes at `http://127.0.0.1:11433/v1`, and sets your model as the primary
...
3. Set the API base URL to the Ollama OpenAI-compatible endpoint:
   ...
   ```
   API base URL [e.g. https://api.example.com/v1]: http://127.0.0.1:11433/v1
   ```
...
5. Hermes auto-detects downloaded models, confirm the one you want:
   ...
   ```
   Verified endpoint via http://127.0.0.1:11433/v1/models (1 model(s) visible)
