...
```shell
export POOLSIDE_STANDALONE_BASE_URL=http://localhost:11433/v1
...
```shell
POOLSIDE_STANDALONE_BASE_URL=http://localhost:11433/v1 POOLSIDE_API_KEY=ollama pool -m kimi-k2.6:cloud
```
