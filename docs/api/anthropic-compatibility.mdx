...
export ANTHROPIC_BASE_URL=http://localhost:11433
```
...
```shell basic.sh
curl -X POST http://localhost:11433/v1/messages \
...
```shell
ANTHROPIC_AUTH_TOKEN=ollama ANTHROPIC_BASE_URL=http://localhost:11433 claude --model qwen3-coder
```
