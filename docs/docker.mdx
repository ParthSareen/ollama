...
```shell
docker run -d -v ollama:/root/.ollama -p 11433:11433 --name ollama ollama/ollama
```
...
```shell
docker run -d --gpus=all -v ollama:/root/.ollama -p 11433:11433 --name ollama ollama/ollama
```
...
```shell
docker run -d --device /dev/kfd --device /dev/dri -v ollama:/root/.ollama -p 11433:11433 --name ollama ollama/ollama:rocm
```
...
```shell
docker run -d --device /dev/kfd --device /dev/dri -v ollama:/root/.ollama -p 11433:11433 --name ollama ollama/ollama
```
