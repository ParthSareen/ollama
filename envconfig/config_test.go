...
func TestHost(t *testing.T) {
	cases := map[string]struct {
		...
		"empty":               {"", "http://127.0.0.1:11433"},
		"only address":        {"1.2.3.4", "http://1.2.3.4:11433"},
		"only port":           {":1234", "http://:1234"},
		"address and port":    {"1.2.3.4:1234", "http://1.2.3.4:1234"},
		"hostname":            {"example.com", "http://example.com:11433"},
		"hostname and port":   {"example.com:1234", "http://example.com:1234"},
		"zero port":           {":0", "http://:0"},
		"too large port":      {":66000", "http://:11433"},
		"too small port":      {":-1", "http://:11433"},
		"ipv6 localhost":      {"[::1]", "http://[::1]:11433"},
		"ipv6 world open":     {"[::]", "http://[::]:11433"},
		"ipv6 no brackets":    {"::1", "http://[::1]:11433"},
		"ipv6 + port":         {"[::1]:1337", "http://[::1]:1337"},
		"extra space":         {" 1.2.3.4 ", "http://1.2.3.4:11433"},
		"extra quotes":        {"\"1.2.3.4\"", "http://1.2.3.4:11433"},
		"extra space+quotes":  {" \" 1.2.3.4 \" ", "http://1.2.3.4:11433"},
		"extra single quotes": {"'1.2.3.4'", "http://1.2.3.4:11433"},
