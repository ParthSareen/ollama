...
func TestClientFromEnvironment(t *testing.T) {
	...
	testCases := map[string]*testCase{
		"empty":                      {value: "", expect: "http://127.0.0.1:11433"},
		"only address":               {value: "1.2.3.4", expect: "http://1.2.3.4:11433"},
		...
		"hostname":                   {value: "example.com", expect: "http://example.com:11433"},
		...
		"trailing slash":             {value: "example.com/", expect: "http://example.com:11433"},
